...
<div>
    <input type="number" name="personne" id="personne" placeholder="personne" class="@error('personne') is-invalid @enderror form-control" value="{{ old('personne', $reservation->personne) }}">
    @error('personne')
    <div class="alert alert-danger">
        {{ $message }}
    </div>
